...
urlpatterns = [
    ...
    url(r'^proposal/(?P<proposalname>\d+)/shell/CA/$', views.displayShellConsequences, name='resultShell'),
    url(r'^proposal/(?P<proposalname>\d+)/bottom/CA/$', views.displayBottomConsequences, name='resultBottom'),
